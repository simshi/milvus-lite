""" example to connect an existing running server, e.g. ~/.local/bin/milvus-server
"""
...
def drop_collection(name):
    print(f"Droping collection:{name}...")
...
def insert(collection, num, dim):
    print(f"Inserting data:{num}x{dim}...")
    data = [
...
def create_index(collection, filed_name):
    print(f"Creating index:{filed_name}...")
    index_param = {
